...
public class QuoteController extends BaseController {
	...
	public String list(HttpServletRequest request, Model model,
			String currentPager) {
		logger.info("{}查询金句分享列表 shareType={}", MANAGE_NAME);
		requestMessageProcess(request);

		Map<String, Object> pager = shareService.queryForPager("A", currentPager, pagerSize);
	...
	public Result doEdit(Model model, Share share) {
		...
		result.setRedirectUrl("/manage/quote/list");
