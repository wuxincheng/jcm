...
import com.wuxincheng.util.FileUploader;
import com.wuxincheng.util.FileUploader.UploadInfo;
import com.wuxincheng.util.ImageUtil;
...
public class ImageController {
	...
	@RequestMapping("/crop")
    @ResponseBody
    Map<String, Object> crop(String imgUrl, Double imgW, Double imgH, Double imgX1, Double imgY1,
            Double cropW, Double cropH) throws Exception {
        ...
        if (StringUtils.isEmpty(imgUrl) || imgW == null || imgH == null || imgX1 == null
                || imgY1 == null || cropW == null || cropH == null) {
        ...
        ImageUtil.crop(imgPath, dest, imgW.intValue(), imgH.intValue(), imgX1.intValue(),
                imgY1.intValue(), cropW.intValue(), cropH.intValue());
