...
<body>
  ...
  <div class="container main-container">
    <h5 class="page-header page-target">首页图片管理</h5>
    <a href="${root}/manage/share/edit">
      <button type="button" class="btn btn-primary btn-sm">新增</button>
    </a>
    <hr />
    <div style="text-align: right; color: #CE9D9D; padding-bottom: 10px;">提示：目前显示前5张图片，并且最多只能显示5张图片</div>
              ...
              <c:forEach items="${pager.shares}" var="obj" varStatus="s">
                <tr>
                  ...
                  <td style="text-align: center;">
                    <img src="${obj.shareImage}" style="width: 60px;" />
                  </td>
                  <td style="text-align: left;">${fn:substring(obj.shareContent, 0, 15)} ... ...</td>
                  ...
                  <td style="text-align: center;">
                    <a href="${root}/manage/share/detail?shareid=${obj.shareid}">
...
function delShare(shareid){
	layer.confirm('您确定要删除吗？', {
		...
		document.location = '${root}/manage/share/delete?shareid='+shareid;
	}, function(){
	    layer.msg('并没有删除哦');
	});
}
